...
if __name__ == "__main__":
    ...
    checkpoint = torch.load('models_DM/dm_epoch_300.pt', map_location=device)
    ...
    for i, e in enumerate(energies):
        ...
        plt.tight_layout()
        plt.savefig(f"/web/aratey/public_html/delight/nf/models_DM/run_1/gen_{i}_DM.png", bbox_inches='tight', dpi=300)

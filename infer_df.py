...
if __name__ == "__main__":
    ...
    for i, e in enumerate(energies):
        ...
        fig_corner = corner.corner(gen, color="red", labels=["Phonon", "Triplet", "UV", "IR"], truths=None, show_titles=True)
        plt.savefig(f"{save_dir}/corner_gen_{i}.png", bbox_inches='tight', dpi=300)

        # Optional: Corner plot for simulation data (for comparison)
        fig_corner_sim = corner.corner(sim, color="blue",labels=["Phonon", "Triplet", "UV", "IR"], truths=None, show_titles=True)
        plt.savefig(f"{save_dir}/corner_sim_{i}.png", bbox_inches='tight', dpi=300)

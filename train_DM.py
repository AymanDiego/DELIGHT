...
def train_diffusion_model(diffusion_model, data_train, data_val, num_epochs=301, batch_size=512, learning_rate=1e-3, weight_decay=1e-5, model_dir='models_DM/', num_timesteps=1000, noise_magnitude=0.1, energy_threshold=50.0):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.savefig("/web/aratey/public_html/delight/nf/models_DM/DM_old/run_14/loss.png", bbox_inches='tight', dpi=300)
    plt.savefig("/web/aratey/public_html/delight/nf/models_DM/DM_old/run_14/loss.pdf", bbox_inches='tight')

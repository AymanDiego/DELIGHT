...
import numpy as np
import torch
from model_old import ConditionalNormalizingFlowModel  # Importing the model from model.py
...
if __name__ == "__main__":
    ...
    for i,e in enumerate(energies):
        ...
        plt.tight_layout()
        plt.savefig(f"/web/aratey/public_html/delight/nf/models_nf/run_old_1/gen_{i}.png",bbox_inches='tight',dpi=300)
